...
const databaseRenderer = window.KumoDatabaseRenderer.createDatabaseRenderer({
  ...
  getDatabaseLessonStep: () => ({
    step: databaseLessonSteps[databaseLessonStep],
    index: databaseLessonStep,
    total: databaseLessonSteps.length,
  }),
  speak,
  saveState,
  shuffle,
...
const renderDatabaseLesson = databaseRenderer.renderDatabaseLesson;
const renderDatabaseVocabulary = databaseRenderer.renderDatabaseVocabulary;
...
const dailyLessonRenderer = window.KumoDailyLesson.createDailyLessonRenderer({
  $,
  $$,
  course,
  state,
